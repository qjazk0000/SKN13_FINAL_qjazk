              ...
              onClick={() => {
                ...
                try {
                  if (typeof row.extracted_text === "string") {
                    parsedExtractedText = JSON.parse(
  ...
  const handleExcelDownload = async () => {
    try {
      ...
      const response = await api.get(
        `/admin/receipts/download?${params.toString()}`,
        {
          responseType: "blob",
          headers: {
            ...
            {!error && receipts.length > 0 && (
              <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-sm text-green-800">
                  총 <span className="font-medium">{totalCount}</span>건의
                  영수증을 찾았습니다.
                  {(startDate || endDate) && (
            ...
            >
              ...
              <div className="w-full md:w-[420px] bg-gray-50 rounded-lg p-4 border">
                ...
                <div className="mb-2 text-base text-gray-800">
                  ...
                  {Array.isArray(popupReceipt.extracted_text?.품목) &&
                  popupReceipt.extracted_text?.품목.length > 0 ? (
